    ...
    >
      ...
      <div className="relative flex w-full flex-col-reverse gap-16 md:flex-row 3xl:max-w-[1200px]">
        ...
        <motion.div
         ...
         <img src={health} alt="" className={`absolute z-[10] h-full w-full object-cover transition-all duration-300 ${position <= 4 ? "bg-opacity-100" : "opacity-100"}`}/>
        </motion.div>
          {/* Left pannel content */}
          ...
          {/* right pannel content */}
            <div className="relative mt-6 flex w-full flex-col items-center justify-center gap-6">
                ...
                <div className="[544px] absolute left-0 top-0 h-full w-1 bg-[#eaecf0]">
                   <motion.div className="h-[70px] w-1 rounded-full bg-violet-700"
                   style={{height:height}}/>
                </div>
                {/* Border line content */}
                ...
                <div className={`py-4 pl-6 transition-all ${position === 2 ? "opacity-100" : "opacity-30"}`}>
                  <h5 className="text-[20px] font-bold leading-[30px] text-[#0e1829]">Restorative Density</h5>
                  <p className="mt-2 text-base font-medium leading-6 text-[#445469]">
                ...
                <div className={`py-4 pl-6 transition-all ${position === 3 ? "opacity-100" : "opacity-30"}`}>
                  <h5 className="text-[20px] font-bold leading-[30px] text-[#0e1829]">Surgical Interventions</h5>
                  <p className="mt-2 text-base font-medium leading-6 text-[#445469]">
                    Even the all-powerfull pointing has no control about the blind texts it is an almost unorthographic life.
                  </p>
                </div>
                <div className={`py-4 pl-6 transition-all ${position === 4 ? "opacity-100" : "opacity-30"}`}>
                  <h5 className="text-[20px] font-bold leading-[30px] text-[#0e1829]">Health Monitoring</h5>
                  <p className="mt-2 text-base font-medium leading-6 text-[#445469]">
                  Our dedicated team of medical professionals is here to guide you on your health journey.
                  </p>
                </div>
